...
class ClosePredictionsByPoolRoundAndGameActionTest extends TestCase
{
    use RefreshDatabase;
    use WithoutEvents;
     ...
     * @return void
     */
    public function testCreatePoolRoundAndAllGamesIsFinish()
    {
        ...
        $Games->each(
            function (Game $Game) use ($PoolRound) {
                ...
                $PoolRound = $this
                    ->ClosePredictionsByPoolRoundAndGame
    ...
    public function testCreatePoolRoundAndAllGamesNotFinished()
    {
